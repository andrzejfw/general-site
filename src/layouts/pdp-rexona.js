...
import CarouselRexona from '../components/CarouselRexona/CarouselRexona'
import Accordion from "../components/AccordionRexona/AccordionRexona"
import Button from "../components/ButtonRexona"
...
import RexonaBullets from '../assets/images/rexona-bullets.png'
...
const ProductBullets = styled.div`
    ...
    li{
        ...
        list-style: none;
        background-image: url(${RexonaBullets});
        ...
        {/* <BulletsDown><img></img></BulletsDown> */}
          <SectionAccordion>
            <Accordion>
              ...
              {/* Allergens */}
              <AccordionTab label="Safety measures">
